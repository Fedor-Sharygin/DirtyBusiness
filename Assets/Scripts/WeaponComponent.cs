...
public class WeaponComponent : MonoBehaviour
{
    ...
    public bool Attack(Vector2 p_Direction)
    {
        ...
        var ObjectHits = Physics2D.CircleCastAll((Vector2)transform.position + p_Direction * m_MinDist, m_CurrentWeapon.m_BlastRadius, p_Direction, m_CurrentWeapon.m_Distance);
